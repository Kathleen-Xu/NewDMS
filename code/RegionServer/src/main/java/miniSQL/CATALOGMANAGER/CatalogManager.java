...
public class CatalogManager {
	private static Hashtable<String,table> tables=new Hashtable<>() ;
	private static Hashtable<String,index> indexes=new Hashtable<>();
	...
	public static Hashtable<String, table> getTables() {
		return tables;
	}

	public static Hashtable<String, index> getIndex() {
		return indexes;
	}
